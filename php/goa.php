...
if (isset($_POST['name'])) {
  ...
  $sql = "INSERT INTO `goa` (`name`, `age`, `gender`, `email`, `phone`,
...
<body>
  <img class="bg" src="images/goa.jpg" alt="goa" />
  <div class="container">
    <h1>Welcome to Goa Trip</h1>
    <p>
      <br>
      Enter Your Details to confirm your booking
      <br>
      Pay Rs. 12999 to travel.com@apl upi id
    </p>
    ...
    <form action="/aman/travel/php/goa.php" method="post">
