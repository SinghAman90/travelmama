...
if (isset($_POST['name'])) {
  ...
  $sql = "INSERT INTO `jaipur` (`name`, `age`, `gender`, `email`, `phone`,
...
<body>
  <img class="bg" src="images/jaipur.jpg" alt="jaipur" />
  <div class="container">
    <h1>Welcome to Jaipur Trip</h1>
    <p>
      <br>
      Enter Your Details to confirm your booking
      <br>
      Pay Rs. 15999 to travel.com@apl upi id
    </p>
    ...
    <form action="/aman/travel/php/jaipur.php" method="post">
