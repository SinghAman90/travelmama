...
if (isset($_POST['name'])) {
  ...
  $sql = "INSERT INTO `kerala` (`name`, `age`, `gender`, `email`, `phone`,
...
<body>
  <img class="bg" src="images/kerala.jpg" alt="kerala" />
  <div class="container">
    <h1>Welcome to kerala Trip</h1>
    <p>
      <br>
      Enter Your Details to confirm your booking
      <br>
      Pay Rs. 9999 to travel.com@apl upi id
    </p>
    ...
    <form action="/aman/travel/php/kerala.php" method="post">
