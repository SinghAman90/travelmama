...
if (isset($_POST['name'])) {
  ...
  $sql = "INSERT INTO `manali` (`name`, `age`, `gender`, `email`, `phone`,
...
<body>
  <img class="bg" src="images/manali.jpg" alt="Manali" />
  <div class="container">
    <h1>Welcome to Manali Trip</h1>
    <p>
      <br>
      Enter Your Details to confirm your booking
      <br>
      Pay Rs. 8999 to travel.com@apl upi id
    </p>
    ...
    <form action="/aman/travel/php/manali.php" method="post">
